...
if(NOT CACHED_URL STREQUAL "")
   ...
   if(IS_FILE_URL)
      ...
      set(OPENAL_C17_URL "${CACHED_URL}/${OPENAL_C17_FILE}")
      ...
      set(OPENCL_URL "${CACHED_URL}/${OPENCL_FILE}")
      set(LIBZIP_URL "${CACHED_URL}/${LIBZIP_FILE}")
      set(CORRADE_URL "${CACHED_URL}/${CORRADE_FILE}")
      set(MAGNUM_URL "${CACHED_URL}/${MAGNUM_FILE}")
      set(VSG_URL "${CACHED_URL}/${VSG_FILE}")
      ...
      set(OPENAL_C17_URL "${CACHED_URL}/${OPENAL_C17_FILE} ${OPENAL_C17_URL}")
      ...
      set(OPENCL_URL "${CACHED_URL}/${OPENCL_FILE} ${OPENCL_URL}")
      set(LIBZIP_URL "${CACHED_URL}/${LIBZIP_FILE} ${LIBZIP_URL}")
      set(CORRADE_URL "${CACHED_URL}/${CORRADE_FILE} ${CORRADE_URL}")
      set(MAGNUM_URL "${CACHED_URL}/${MAGNUM_FILE} ${MAGNUM_URL}")
      set(VSG_URL "${CACHED_URL}/${VSG_FILE} ${VSG_URL}")
...
function(SD_DownloadIfNeeded FILE_DESTINATION SRC_URL)
   ...
   if(DL_STATUS)
      ...
      if(NOT STAT_NUM EQUAL 0)
         ...
         message(STATUS "Downloaded ${FILE_DESTINATION} from ${SRC_URL}")
      endif()
   endif()
endfunction()
...
SD_DownloadIfNeeded(${DOWNLOAD_DIRECTORY}/${OPENAL_C17_FILE} ${OPENAL_C17_URL})
...
SD_DownloadIfNeeded(${DOWNLOAD_DIRECTORY}/${OPENCL_FILE} ${OPENCL_URL})
SD_DownloadIfNeeded(${DOWNLOAD_DIRECTORY}/${LIBZIP_FILE} ${LIBZIP_URL})
SD_DownloadIfNeeded(${DOWNLOAD_DIRECTORY}/${CORRADE_FILE} ${CORRADE_URL})
SD_DownloadIfNeeded(${DOWNLOAD_DIRECTORY}/${MAGNUM_FILE} ${MAGNUM_URL})
SD_DownloadIfNeeded(${DOWNLOAD_DIRECTORY}/${VSG_FILE} ${VSG_URL})
